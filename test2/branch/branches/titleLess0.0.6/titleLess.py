...
dungeonFile = media.loadReadFile(os.path.join('data', 'maps', 'mapa1.xml'))
...
pantalla.blit(background, (0, 0))
dracko = ManejadorPersonaje(mapa, media, 5, 5, 40, 40)
pygame.display.update()
pygame.display.update()

[Vivora(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 5)]
[VivoraRapida(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 100)]
[VivoraFuerte(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]
[Pocion(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]
[Fuego(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]
[Pico(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]
[PicoFuerte(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]
[PicoRapido(mapa, media, random.randint(0, len(mapa.ocupado) - 2), random.randint(0, len(mapa.ocupado[0]) - 2), 40, 40) for i in range(0, 20)]

#[Vivora(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 5)]
#[VivoraRapida(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 5)]
#[VivoraFuerte(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 5)]
#[Pocion(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 20)]
#[Fuego(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 20)]
#[Pico(mapa, media, random.randint(0, 20), random.randint(0, 20), 40, 40) for i in range(0, 20)]
#[Megaterio(mapa, media, random.randint(0, 20), random.randint(0, 20), 80, 40) for i in range(0, 10)]
