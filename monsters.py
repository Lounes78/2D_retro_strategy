    ...
    def move_randomly(self, other_monsters, player_units):
        ...
        for direction in directions:
            ...
            if (
                ...
                all(monster.mapPosition != [new_row, new_col] for monster in other_monsters) and 
                all(unit.mapPosition != [new_row, new_col] for unit in player_units)  
            ):
...
def create_monsters(dungeon, media):
    monsters = [
        WaterMonster(dungeon, media, [3, 8]),
        OctopusMonster(dungeon, media, [7, 11]),
        FlyMonster(dungeon, media, [11, 8]),
        PoisonMonster(dungeon, media, [15, 11]),
    ]
    return monsters
