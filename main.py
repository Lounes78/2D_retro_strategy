...
class Game:
    ...
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Echoes of Isometry")
        ...
        self.logo = [
            self.media.loadImage(os.path.join('data', 'logo', f'title_{num}.png'))
    ...
    def run_hello_screen(self):
        ...
        while True:
            ...
            if flag:
                ...
                self.screen.blit(self.font, (self.center_font_x, self.center_font_y-320))
        ...
        while True:
            ...
            for monster in self.monsters[:]:
                if monster.marked_for_removal and pygame.time.get_ticks() - monster.removal_time > 500:
                    self.monsters.remove(monster)
                    players[1-active_player_index].score+=500
            self.display_scores()
